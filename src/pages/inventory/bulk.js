...
const Page = () => {
  const auth = useAuth()
  const [bottomNavValue, setBottomNavValue] = useState("bulkupdates"); // State to manage bottom navigation value
      ...
      >
        <Container maxWidth="xl">
          <Stack spacing={3}>
            ...
            >
              <Stack spacing={1}>
                <Typography>Bulk Updates</Typography>
              </Stack>
            </Stack>
            ...
            <Paper sx={{ position: 'fixed', bottom: 0, left: 0, right: 0 }} elevation={3}>
              ...
              >
                ...
                <BottomNavigationAction label="Bulk Update" value="bulkupdates" component={NextLink} href='/inventory/bulk' icon={<SyncAltOutlined />} />
              </BottomNavigation>
            </Paper>
          </Stack>
        </Container>
